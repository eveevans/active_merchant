...
class RemoteCredomaticCardinalTest < Test::Unit::TestCase
  def setup
    @gateway = CredomaticCardinalGateway.new(fixtures(:credomatic_cardinal))
  ...
  def test_invalid_login
    gateway = CredomaticCardinalGateway.new(login: '', password: '')
