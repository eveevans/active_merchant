module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    class CredomaticCardinalGateway < Gateway

      # Test mode is enable manually on Cardinal Control Panel
      ...
      self.supported_countries = ['NI', 'CR', 'MX', 'HN', 'SV', 'GT', 'PA']
      ...
      def split_authorization(authorization)
        authcode, transactionid, time, purshamount = authorization.split("|")
        [authcode, transactionid, time, purshamount]
      end

      def add_reference(post, authorization)
        authcode, transactionid, time, purshamount = split_authorization(authorization)
